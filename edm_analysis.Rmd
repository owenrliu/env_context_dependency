...
mei.pdo.npgo.ts.plot <-westend %>%
  ...
  labs(title="Physical Drivers: Climate Modes",x="Year",y="Normalized Index Value",col="Driver")+
...
sst.waves.ts.plot <-westend %>%
  ...
  geom_line(lwd=1.5)+
  geom_hline(yintercept=0,linetype=2,col="black")+
  labs(title="Physical Drivers: Temperature and Disturbance",x="Year",y="Normalized Index Value",col="Driver")+
  theme(axis.title=element_text(size=10),
        legend.position = 'bottom',
        legend.text = element_text(size=10))
lay <- rbind(1,2,3,3)
...
ymac_ints_plot <- ggplot(ymac_ints_ts,aes(date_str,meanval,col=plotting))+
  ...
  scale_color_npg()+
  geom_hline(yintercept=0,linetype=2)+
  labs(x="Year",y="Effect on Macrocystis <1m",color="Interacting\nSpecies")
...
# ggsave("C:/Users/Owen.Liu/Documents/github/EDM_SNI/plots/back_select_allplots.pdf",back_select_allplots,h=8,w=6)
# ggsave("C:/Users/Owen.Liu/Documents/github/EDM_SNI/plots/back_select_allplots.png",back_select_allplots,h=8,w=6)
